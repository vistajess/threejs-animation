	var table = [
				...
				"", "", "20.1797", 18, 2,
				"", "", "22.98976...", 1, 3,
				"", "Magnesium", "24.305", 2, 3,
				"", "Aluminium", "26.9815386", 13, 3,
			...
			function init() {
				...
				for ( var i = 0; i < table.length; i+=5) {
					...
					element.style.backgroundImage = 'url(' +  images[Math.ceil(Math.random() * (4 - 0) + 0)]  + ')';

					var object = new THREE.CSS3DObject( element );
					object.position.x = Math.random() * 3000 - 2000;
					object.position.y = Math.random() * 2000 - 800;
					object.position.z = Math.random() * 1000 - 2000;
					...
					object.position.x = ( table[ i + 3] * 90) - 990;
					object.position.y = - ( table[ i + 3] * 90 ) + 500;
